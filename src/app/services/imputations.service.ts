...
export class ImputationsService {
  ...
  // LoadImputations(pWeek: string): Observable<any> {
  //   console.log('pWeek', pWeek);
  //   const employee = JSON.parse(localStorage.getItem('employee')!);
	// 	const weekAndEmployeeId = { "week": pWeek, "employee_Id": employee.employee_Id };

  //   const imputationsWeek = this.httpClient.post(this.baseUrl + 'Imputation/GetImputationsByEmployeeByWeek', weekAndEmployeeId);
